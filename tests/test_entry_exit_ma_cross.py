...
def test_entry_confirm_failure_bans_key_time():
    ...
    st = _run(_build_df(rows), dict(fastLen=2, slowLen=3, chainer_need_confirm=True))
...
def test_no_confirm_places_orders_immediately(chainer_need_confirm):
    ...
    st = _run(
        ...
        dict(
            fastLen=2,
            slowLen=3,
            chainer_need_confirm=chainer_need_confirm,
