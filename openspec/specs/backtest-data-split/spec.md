...
系统 SHALL 提供 `configs/tasks/downloads/download_2024_eth.json` 配置文件，利用现有 `auto_download` 机制从 Binance 下载 2024 全年 ETH-USDT 1h 数据并存入 MongoDB。
...
- **WHEN** 执行 `bash scripts/backtest_cli.sh configs/tasks/backtests/backtest_train.json`
