...
def demonstrate_use_cases():
    ...
    use_cases = [
        ...
        {"name": "Fully Protected API", "config": "--protected-paths '/api'", "description": "Require authentication for all API calls"},
        {
            "name": "Selective Protection",
            "config": "--protected-paths '/admin,/secure,/internal'",
            "description": "Protect specific sensitive endpoints",
        },
        {"name": "No Protection", "config": "# Don't set --protected-paths", "description": "All endpoints are public (default behavior)"},
    ]
